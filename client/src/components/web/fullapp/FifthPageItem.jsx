...
const FifthPageItem = () => {
    ...
    const [focusEndDate, setFocusEndDate] = useState(Boolean);
                    ...
                    <div className="w-full text-justify bg-white rounded-3xl p-4 mt-4 shadow-[5px_5px_10px_rgba(0,0,0,0.3)] text-sm md:text-lg flex flex-col items-center font-sans">
                        ...
                        <div className="w-full p-5 flex flex-col lg:flex-row justify-between">
                            <div className="w-full lg:w-[30%] flex flex-col lg:ml-4">
                                <TextField
                                    onFocus={() => { setFocusEndDate(true) }}
                                    onBlur={() => { setFocusEndDate(false) }}
                                    variant="standard"
                                    defaultValue="Normal"
                                    margin="dense"
                                    type='date'
                                ...
                                />
                                {focusEndDate && <p className='bg-gray-50 pt-2 rounded-xl'>Approximatley, when did you end working at this previous job?</p>}
                                {errorEndDate !== '' ? (
                            ...
                            <button
                                ...
                                className="bg-[#854fff] w-[30%] h-16 p-2 mx-6 mt-4 rounded-lg text-white text-xl  hover:bg-purple-800"
                            >
                                CONTINUE
                            </button>
                        </div>
